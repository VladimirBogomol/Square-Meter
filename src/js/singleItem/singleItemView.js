export function render(object, isFaved) {
  ...
  const marking = `<div class="container p-0 pt-5">
                <div class="heading-1">
                ...
                <div class="object">
                    ...
                    <div class="object__desc">
                        ...
                        <div class="object__desc-name">
                            ...
                            <button id="add-to-favourite-btn" class="
                            button-favourite
            ...
            <div class="modal">
                <div class="modal__header">
                    ...
                    <div class="modal__details">
                        Квартира ${object.flat_number} в ЖК ${object.complex_name} Дом 5
  ...
  appContainer.insertAdjacentHTML("beforeend", marking);
  appContainer.insertAdjacentHTML("beforeend", markingModal);
}
...
export function toggleFavouriteBtn(isFaved) {
  const btn = document.querySelector("#add-to-favourite-btn");
